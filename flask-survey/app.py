...
def pick_survey():
    ...
    # store the survey code in the session
...
def handle_question():
    ...
    # store the updated responses list in the session
...
@app.route("/complete")
def say_thanks():
    """Survey complete. Thank user and show responses."""
    ...
    # Set cookie indicating this survey is done so they can't re-do it
